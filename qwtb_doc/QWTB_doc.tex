...
% ostatni:
\usepackage[unicode]{hyperref}                   % klikatelne odkazy v pdfkach
...
\lstset{ %
  ...
  %belowskip=-10pt                  % skip after end of lstlistings
}
...
%%% MOTO: press a button with bold title AMPLITUDE - (drink a coffee) - and get the result
\newpage
...
\section{Toolbox basic scheme} %<<<1 ------------------------------
...
\subsection{Application of an algorithm on the data} %<<<2 ------------------------------
\begin{lstlisting}
...
\subsection{Running an example of algorithm use} %<<<2 ------------------------------
...
\subsection{Running a test of algorithm} %<<<2 ------------------------------
...
\subsection{Adding or removing algorithm path} %<<<2 ------------------------------
...
\section{Algorithm directory structure implementation} %<<<1 ------------------------------
...
\subsection{File {\tt alg\_info.m}} %<<<2 ------------------------------
\label{filealginfo}
...
\subsection{File {\tt alg\_wrapper.m}} %<<<2 ------------------------------
...
\subsection{File {\tt alg\_test.m}} %<<<2 ------------------------------
\label{filealgtest}
...
\subsection{File {\tt alg\_example.m}} %<<<2 ------------------------------
...
\section{Algorithm informations structure} %<<<1 ------------------------------
\label{structalginfo}
...
\subsection{Quantity structure examples} %<<<2 ------------------------------
...
\begin{description}
        ...
        the computer can be used by other tasks also. %XXX is it only for 'multicore'?
...
% 
% 
% \section{Toolbox file structure} %<<<1 ------------------------------
...
% \end{center}
% 
% \section{Graphical User Interface} %<<<1 ------------------------------
% 
