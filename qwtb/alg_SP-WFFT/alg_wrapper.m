...
[dataout.f.v, ...
 ...
 dataout.w.v, ...
 dataout.NENBW.v, ...
 dataout.ENBW.v] = ampphspectrum(datain.y.v, ...
                                 fs, ...
                                 0, ...
                                 '', ...
                                 win, ...
...
dataout.f.v = dataout.f.v(:)';
dataout.A.v = dataout.A.v(:)';
dataout.ph.v = dataout.ph.v(:)';
dataout.SD.v = dataout.SD.v(:)';
dataout.w.v = dataout.w.v(:)';
