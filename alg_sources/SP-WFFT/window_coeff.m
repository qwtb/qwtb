...
## -*- texinfo -*-
## @deftypefn  {Function File} {@var{w} =} window_coeff ()
## @deftypefnx {Function File} {@var{w} =} window_coeff (@var{win}, @var{L})
## @deftypefnx {Function File} {@var{w} =} window_coeff (@var{win}, @var{L}, [ @var{par} ] )
## @deftypefnx {Function File} {@var{w} =} window_coeff (..., 'periodic')
## Obtains window coefficients of window function @var{win}
## for length @var{L}. Some windows requires additional parameter
## @var{par}. If not specified, a default value of window function is used.
##
## If keyword 'periodic' is supplied, a window wraps around the cyclic interval and is intended for
## use with the DFT.
##
## Without input arguments, a list of known window functions is returned.
##
## Example:
## Generate window coefficients for welch window function:
## @example
