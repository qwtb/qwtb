...
## -*- texinfo -*-
## @deftypefn {Function File} {@var{w}} = flattop (@var{t},@var{n})
## Function generates symmetric flat top window coefficients @var{w} 
## of length @var{n} and type @var{t}. Parameter @var{n} sets the
## length of the window, so it can be different than
## signal length. Parameter @var{t} selects type of flat
## top window:
## @table @samp
##      @item 1 
...
## @end table
## @end deftypefn
## @cite{G. Heinzel, ‘Spectrum and spectral density estimation by the Discrete Fourier transform (DFT), including a comprehensive list of window functions and some new flat-top windows’, IEEE, 2003.}
## @cite{https://www.mathworks.com/help/signal/ref/flattopwin.html}
## @cite{D'Antona, Gabriele, and A. Ferrero. Digital Signal Processing for Measurement Systems. New York: Springer Media, 2006, pp. 70–72.}
## @cite{Gade, Svend, and Henrik Herlufsen. "Use of Weighting Functions in DFT/FFT Analysis (Part I)." Windows to FFT Analysis (Part I): Brüel & Kjær Technical Review, No. 3, 1987, pp. 1–28.}
