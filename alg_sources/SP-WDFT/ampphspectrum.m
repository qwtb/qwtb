...
## -*- texinfo -*-
## @deftypefn {Function File} {[@var{f}, @var{amp}, @var{ph}] = ampphspectrum (@var{y}, @var{fs}, [@var{verbose}, @var{stem_plot}, @var{win}, @var{winparam}, @var{padding}]) }
##  
...
## frequency @var{fs}. Function returns returns frequency vector @var{f}, amplitudes @var{amp} and
## phases @var{ph}.
## 
## If @var{verbose} is set, two figures with amplitude and phase will be plotted as stem plots (or line
## plots if @var{stem_plot} is set to 0).
## 
## Window function will be used if if @var{win} contains name of window function. Some window
