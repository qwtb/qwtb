...
\input{alg_examples_published/info_ADEV.tex}
\section*{\examplesection} %<<<2 ------------------------
\input{alg_examples_published/doc_ADEV.tex}
...
% function and converted by bash script betterpublish.
\section*{\infosection} %<<<2 -------------------
\input{alg_examples_published/info_INL-DNL.tex}
\section*{\examplesection} %<<<2 ------------------------
\input{alg_examples_published/doc_INL-DNL.tex}

\chapter{SFDR -- Spurious Free Dynamic Range} %<<<1 ------------------------------
% included files are automatically generated by info_all_algs.m script and by Matlab publish
% function and converted by bash script betterpublish.
\section*{\infosection} %<<<2 -------------------
\input{alg_examples_published/info_SFDR.tex}
\section*{\examplesection} %<<<2 ------------------------
\input{alg_examples_published/doc_SFDR.tex}

\chapter{MADEV -- Modified Allan Deviation} %<<<1 ------------------------------
% included files are automatically generated by info_all_algs.m script and by Matlab publish
% function and converted by bash script betterpublish.
\section*{\infosection} %<<<2 -------------------
\input{alg_examples_published/info_MADEV.tex}
\section*{\examplesection} %<<<2 ------------------------
\input{alg_examples_published/doc_MADEV.tex}

\chapter{OADEV -- Overlapping Allan Deviation} %<<<1 ------------------------------
% included files are automatically generated by info_all_algs.m script and by Matlab publish
% function and converted by bash script betterpublish.
\section*{\infosection} %<<<2 -------------------
\input{alg_examples_published/info_OADEV.tex}
\section*{\examplesection} %<<<2 ------------------------
\input{alg_examples_published/doc_OADEV.tex}
