...
\end{center}
\newpage
% Start main table of contents
% (it has to be separated from local tables of contents in the examples)
\startcontents[maintoc]
% Print main table of contents
...
% Stop main table of contents. The example will start its own local TOC.
...
\lstinputlisting{../qwtb/qwtbvar_example_1_process.m}

\chapter{Complex example of QWTBvar use} %<<<1 ----------------------------------
\section{The example}
% Stop main table of contents. The example will start its own local TOC.
\stopcontents[maintoc]
\input{qwtb_examples_published/qwtbvar_example_2.tex}
% Resume main TOC
\resumecontents[maintoc]
\section{The varied function \texttt{qwtbvar\_example\_2\_process.m}}
\lstinputlisting{../qwtb/qwtbvar_example_2_process.m}
